...
mod lexer_tests {
    use logos::Logos;
    use minisoft_compiler::lexer::error::LexicalErrorType;
    use minisoft_compiler::lexer::lexer_core::tokenize;
    use minisoft_compiler::lexer::token::Token;
    ...
    fn test_string_literals() {
        ...
        assert_eq!(
            lexer.next(),
            Some(Ok(Token::StringLiteral("hello".to_string())))
        );
        assert_eq!(
            lexer.next(),
        ...
        assert_eq!(
            lexer.next(),
            Some(Ok(Token::StringLiteral("123".to_string())))
        );
    ...
    fn test_valid_identifiers() {
        ...
        assert_eq!(
            lexer.next(),
            Some(Ok(Token::Identifier("a_b_c".to_string())))
        );
        assert_eq!(
            lexer.next(),
            Some(Ok(Token::Identifier("Some123thing".to_string())))
        );
        assert_eq!(lexer.next(), None);
    }
    ...
    fn test_multiline_comments() {
        ...
        assert_eq!(
            lexer.next(),
            Some(Ok(Token::Identifier("start".to_string())))
        );
